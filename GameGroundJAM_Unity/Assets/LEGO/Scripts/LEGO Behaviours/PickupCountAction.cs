...
{
    public class PickupCountAction : Action
    {
        [SerializeField, Tooltip("The variable to modify.")]
        Variable m_Variable = null;

        public static Action<PickupCountAction> OnAdded;
        public static Action<PickupCountAction> OnCollected;
        ...
        const float k_HoverAmplitude = 1 * LEGOVerticalModule;
